...
public class SystemAdministrator extends Member {
	 ...
	 * 
	 * public SystemAdministrator(TicketBookingSystem system) { this.system =
	 * system; }
	 * 
	 ...
	 * 
	 * public TicketBookingSystem getSystem() { return system; }
	 * 
	 * public void setSystem(TicketBookingSystem system) { this.system = system; }
	 */
}